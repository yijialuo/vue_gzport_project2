<template>
  <div class="index" v-loading.fullscreen.lock="fullscreenLoading" element-loading-text="拼命加载中...">
    ...
    <el-table :data="excelData" tooltip-effect="dark">
      ...
      <el-table-column align="center" label="分量" prop="size" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" label="口味" prop="taste" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" label="单价(元)" prop="price" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" label="剩余(份)" prop="remain" show-overflow-tooltip></el-table-column>
    </el-table>
  </div>
</template>
